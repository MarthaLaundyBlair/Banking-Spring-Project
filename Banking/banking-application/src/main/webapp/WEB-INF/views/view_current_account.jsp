...
<body>
 ...
 <% Customer c = (Customer)session.getAttribute("loggedInCustomer"); %>
   ...
   <h1><%= " " + c.getFirstname() + "'s Current Account!" %> </h1>
    

 <% CurrentAccount account = (CurrentAccount)session.getAttribute("currentAccountToView"); %>
...
Overdraft : <%= " " + account.getOverdraft() %> <br><br>
